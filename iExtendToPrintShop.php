...
it more secure and mobile friendly. iExtend was incompatible with mobile devices for the most part. Our 
new Print Shop system is usable in all ways on a mobile device.</p>

<h3>An Improved Home Page</h3>
<img src="Images/homeChange.jpg" alt="home-change" />
<p>When you first log in you are now presented with a new home page, rather than just being sent straight
to the create options as with iExtend. This page shows you some of the top questions we've been 
receiving, recent important announcements, and a contact form. Use the contact form any time to be in
contact with a Fireworks Over America representative for any questions you may have.</p>
