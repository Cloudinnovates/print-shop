...
<div id="leftContent">
<ul id="sideLinks">
<a href="Pages/Reports/orders.php" class="sideLink"><li class="active-step">Orders</li></a>
<a href="Pages/Reports/product-performance.php" class="sideLink"><li>Product Performance</li></a>
</ul>
</div>
<?php
...
WHERE UserToPrintShopCart.cartId = '.$_GET['orderNo'].' 
AND UserToPrintShopCart.userId = User.userId AND User.userId =
UserAddress.userId
';	
...
<a href="Pages/Reports/orders.php">Return To Orders</a>
<hr/>
</div>
<h2>Order Summary</h2>
<table cellpadding="5">
...
WHERE UserToPrintShopCart.cartId = '.$_GET['orderNo'].' 
AND UserToPrintShopCart.cartId = PrintShopCartItem.cartId
