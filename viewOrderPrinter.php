...
WHERE UserToPrintShopCart.cartId
...
<a href="printerPortal.php">Back To Orders</a>
<hr/>
</div>
<h2>Order Summary</h2>
<table cellpadding="5">
...
SELECT UserToPrintShopCart.userId, UserToPrintShopCart.cartId, PrintShopCart.cartId,
PrintShopCart.cartTrackingNo, 
...
FROM UserToPrintShopCart, PrintShopCart, PrintShopCartItem, PrintProject, PrintProduct
WHERE UserToPrintShopCart.cartId = '.$_GET['orderNo'].' 
AND UserToPrintShopCart.cartId = PrintShopCart.cartId AND PrintShopCart.cartId = PrintShopCartItem.cartId
AND PrintShopCartItem.printProjId = PrintProject.printProjId 
AND PrintProject.printProdId = PrintProduct.printProdId
';
